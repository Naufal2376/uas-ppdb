...
<div class="fi-logo flex items-center gap-3 text-xl font-bold leading-5 tracking-tight text-gray-950 dark:text-white">
    ...
    <div>
        <span class="block text-base font-bold text-slate-800 dark:text-white">SI-PPDB</span>
